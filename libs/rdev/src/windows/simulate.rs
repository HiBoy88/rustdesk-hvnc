...
use winapi::um::winuser::{
    GetForegroundWindow, GetKeyState, GetKeyboardLayout, GetKeyboardState, GetSystemMetrics,
    GetWindowThreadProcessId, INPUT_u, MapVirtualKeyA, MapVirtualKeyExW, PostMessageA, SendInput,
    SetKeyboardState, ToAscii, VkKeyScanA, VkKeyScanExA, VkKeyScanExW, INPUT, INPUT_KEYBOARD,
    INPUT_MOUSE, KEYBDINPUT, KEYEVENTF_EXTENDEDKEY, KEYEVENTF_KEYUP, KEYEVENTF_SCANCODE,
    KEYEVENTF_UNICODE, MAPVK_VK_TO_CHAR, MAPVK_VK_TO_VSC, MAPVK_VSC_TO_VK, MAPVK_VSC_TO_VK_EX,
    MOUSEEVENTF_ABSOLUTE, MOUSEEVENTF_HWHEEL, MOUSEEVENTF_LEFTDOWN, MOUSEEVENTF_LEFTUP,
    MOUSEEVENTF_MIDDLEDOWN, MOUSEEVENTF_MIDDLEUP, MOUSEEVENTF_MOVE, MOUSEEVENTF_RIGHTDOWN,
    MOUSEEVENTF_RIGHTUP, MOUSEEVENTF_VIRTUALDESK, MOUSEEVENTF_WHEEL, MOUSEEVENTF_XDOWN,
    MOUSEEVENTF_XUP, MOUSEINPUT, SM_CXVIRTUALSCREEN, SM_CYVIRTUALSCREEN, VK_CONTROL, VK_LSHIFT,
    VK_MENU, VK_RSHIFT, VK_SHIFT, WHEEL_DELTA, WM_CHAR, WM_KEYDOWN, WM_KEYUP,
};
...
fn sim_keyboard_event(flags: DWORD, vk: WORD, scan: WORD) -> Result<(), SimulateError> {
    unsafe {
        ...
        let vk = MapVirtualKeyA(scan as _, MAPVK_VSC_TO_VK) as i32;
        ...
        if flags & KEYEVENTF_KEYUP != 0 {
            ...
            //     SetKeyboardState(keyboard_state.as_mut_ptr());
            // }
            // PostMessageA(
            //     enigo::GLOBAL_WND,
            //     WM_KEYUP,
            ...
            // println!("vk_ctrl {}", GetKeyState(VK_CONTROL));
            // println!("DOWN {vk}");
            ...
            if SHIFT_DOWN || CTRL_DOWN {
                ...
                let mut ch = 0_u16;
                ToAscii(vk as _, scan as _, keyboard_state.as_ptr(), &mut ch, 0);

                PostMessageA(enigo::get_gbl_wnd(), WM_CHAR, ch as _, 0);
            } else {
                PostMessageA(enigo::get_gbl_wnd(), WM_KEYDOWN, vk as _, 0);
            }
        }
    }
